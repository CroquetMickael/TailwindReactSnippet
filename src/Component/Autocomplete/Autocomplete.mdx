...
const Input = (props: InputProps) => (
  <>
    <input
      className="flex-1 block py-2 pl-8 pr-6 text-sm text-gray-700 placeholder-gray-400 bg-white border border-b border-gray-400 rounded-l rounded-r appearance-none sm:rounded-l-none focus:bg-white focus:placeholder-gray-600 focus:text-gray-700 focus:outline-none"
      value={props.value}
    ...
    {props.autocomplete ? (
      <button
        className="block py-2 pl-8 pr-6 text-sm bg-red-300 border border-b border-gray-400 rounded-r appearance-none hover:bg-red-500 sm:rounded-l-none"
